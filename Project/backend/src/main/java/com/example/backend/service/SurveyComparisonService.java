...
public class SurveyComparisonService {
    ...
    private static final List<SurveyQuestionPrompt> QUESTIONS = List.of(
            ...
            new SurveyQuestionPrompt(8, "이어폰 사용", List.of("대부분 블루투스 스피커를 사용한다.", "대부분 핸드폰 스피커를 사용한다.", "상황에 따라 스피커와 이어폰을 모두 사용한다.", "대부분 이어폰을 사용한다.", "항상 이어폰만 사용한다.")),
            ...
            new SurveyQuestionPrompt(12, "코골이", List.of("심하게 곤다.", "비교적 조용히 곤다.", "가끔 곤다.", "골지 않는다.", "모른다.")),
            new SurveyQuestionPrompt(13, "흡연", List.of("흡연을 한다.", "흡연하지 않는다.")),
            new SurveyQuestionPrompt(14, "음주", List.of("일주일에 4회 이상", "일주일에 1~2회", "한 달에 1~2회", "가끔 마신다.", "마시지 않는다.")),
            new SurveyQuestionPrompt(15, "음주 후 행동", List.of("매우 시끄러워진다.", "다소 시끄러워지는 편이다.", "평소와 비슷하다.", "조용한 편이다.", "술을 마시지 않는다.")),
            new SurveyQuestionPrompt(16, "야식", List.of("거의 매일 먹는다.", "주 3~5회", "주 1~2회", "한 달에 몇 번", "거의 먹지 않는다.")),
            new SurveyQuestionPrompt(17, "실내 취식", List.of("거의 모든 식사를 집에서 한다.", "자주 집에서 먹는다.", "가끔 먹는다.", "거의 먹지 않는다.", "집에서는 절대 먹지 않는다.")),
            new SurveyQuestionPrompt(18, "청소 방식", List.of("사람을 고용해서 청소한다.", "정해진 당번표 없이 그때그때 필요할 때 치운다.", "상황에 따라 다르게 한다.", "어느 정도 정해진 기준(요일, 담당)을 선호한다.", "명확한 당번표나 규칙을 정해서 지키는 것을 선호한다.")),
