...
public class UserController {
    ...
    private static final Set<String> ALLOWED_TAGS = Set.of(
            ...
            // 문화
            "독서", "전시/미술관", "공연/뮤지컬", "연극", "악기 연주", "북토크/작가와의 만남",
            // 놀이
            "방탈출", "PC방", "클럽/파티", "노래방", "보드게임 카페", "만화카페",
            // 홈라이프
            "인테리어/홈꾸미기", "정리/수납", "홈카페", "홈파티", "캔들/디퓨저",
            // 반려동물
            "강아지", "고양이", "소동물", "파충류/양서류", "관상어", "동물 봉사",
            // 덕질/수집
            "아이돌", "굿즈 수집", "피규어/레고", "프라모델", "포토카드", "스니커즈", "빈티지/앤티크",
            // 뷰티/패션
            "화장품", "향수", "옷 쇼핑", "헤어/그루밍", "네일아트", "타투",
            // 야외
            "여행", "캠핑", "드라이브", "산책", "낚시", "공연/페스티벌",
            // 스포츠 관람
            "야구 관람", "축구 관람", "농구 관람", "배구 관람", "e스포츠 관람",
            // 자기계발
            "공부/자격증", "외국어", "독서모임", "강연/세미나", "온라인 강의", "커리어/이직 준비",
            // 학문
            "역사", "철학", "심리학", "과학", "우주/천문", "경제/경영",
            "정치/시사", "IT/기술", "문학", "수학", "의학/건강",
            // 기타
            "식물 키우기", "재테크", "봉사활동", "타로/사주", "미니멀리즘",
            // MBTI
            "INTJ", "INTP", "ENTJ", "ENTP",
            "INFJ", "INFP", "ENFJ", "ENFP",
            "ISTJ", "ISFJ", "ESTJ", "ESFJ",
